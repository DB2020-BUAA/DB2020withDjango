    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='data_creator', to='mysite.user')),
            ],
        ),
        migrations.AddField(
            model_name='update',
            name='create_user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='update_creator', to='mysite.user'),
        ),
        migrations.CreateModel(
            name='Issue',
            fields=[
                ...
                ('create_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='issue_creator', to='mysite.user')),
        ...
        migrations.AddField(
            model_name='group',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='group_master', to='mysite.user'),
        ),
        migrations.CreateModel(
            name='ExpToGroup',
            fields=[
        ...
        migrations.AddField(
            ...
            name='create_user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='exp_creator', to='mysite.user'),
        ),
        migrations.CreateModel(
            name='DataToUpd',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('info', models.TextField()),
                ('create_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='compare_creator', to='mysite.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('info', models.TextField()),
                ('create_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comment_creator', to='mysite.user')),
                ('target_update', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mysite.update')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='apply_creator', to='mysite.user')),
